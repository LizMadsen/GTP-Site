<template>
  <div class="bg-dark text-dark">
    <div class="row m-0 justify-content-center mt-3">
      <div class="col-md-5 card elevation-2 bg-light mt-5 mx-5 p-5">
        <center>
          <iframe width="560" height="315"
            src="https://www.youtube.com/embed/videoseries?list=PLfNSCHTWj8UPKymDF2tTIZR2Ktx4lg-lM"
            title="YouTube video player" frameborder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowfullscreen class="ytPlaylist"></iframe>
          <h4>Chrono Trigger</h4>
        </center>
      </div>
      <div class="col-md-5 card elevation-2 bg-light mt-5 p-5">
        <center>
          <iframe width="560" height="315"
